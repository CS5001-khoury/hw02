...
def main():
    """Asks a client for a  moving and rating. The rating must be between 1 and 5, and sets stars equal to that number.
    Prints out 
    ...
    If a client enters a value less than 1 or more than 5, it will assume 1 and 5 respectively.
    ...
    Examples:
        ...
        Princess Bride     *****
    """
    pass # remove this line, and start your program from here



# This block of "magic" informs the python interpreter to start executing code in the main() function
# when the file is loaded.
# Since you now know if statements, it is saying, "if this the main file being executed, call the main function()"
